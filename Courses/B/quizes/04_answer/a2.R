...
print(xyplot(end_position~start_position | status, group=strand, data=res2, auto.key=T))
...
print(xyplot(end_position~start_position | status, group=strand, data=res3, auto.key=T))
